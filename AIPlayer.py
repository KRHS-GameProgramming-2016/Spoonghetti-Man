...
class AIPlayer(Player):
    def __init__(self, maxSpeed =5 , pos=[10,10]):
        ...
        self.images = [pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(11).png"), size),
                       ...
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(17).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(18).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(19).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(20).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(21).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(22).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(23).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(24).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(25).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(26).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(25).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(24).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(23).png"), size),
                       pygame.transform.scale(pygame.image.load("rsc/ball/SpoonerM(22).png"), size),
